package com.jinke.community.ui.image;
...
import com.jinke.community.ui.image.util.ProviderUtil;
        ...
        if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
            ...
            if (takeImageFile != null) {
                ...
                if (VERSION.SDK_INT <= VERSION_CODES.M) {
                     ...
                     */
                    uri = FileProvider.getUriForFile(activity, "com.jinke.community.fileprovider", takeImageFile);
                    //加入uri权限 要不三星手机不能拍照
