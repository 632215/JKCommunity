...
public class HeadOperaWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void setOnSelectOperateWindowListener(OnSelectOperateWindowListener listener) {
        this.listener = listener;
    }

    public HeadOperaWindow(Context mContext) {
    ...
    private void initView() {
        View rootView = inflater.inflate(R.layout.window_head_operate, null);
    ...
    public interface OnSelectOperateWindowListener {
        void operate(String relationship);
    }
}
