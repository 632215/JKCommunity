...
public class PhotoFragment extends LazyFragment {
    ...
    private void initView(View view) {
        loading = (ProgressBar) view.findViewById(com.previewlibrary.R.id.loading);
        photoView = (SmoothImageView) view.findViewById(com.previewlibrary.R.id.photoView);
        rootView = view.findViewById(com.previewlibrary.R.id.rootView);
    }
