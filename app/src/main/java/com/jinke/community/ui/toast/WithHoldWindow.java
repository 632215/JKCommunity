...
public class WithHoldWindow extends PopupWindow implements View.OnClickListener {
    ...
    public WithHoldWindow(Context mContext) {
    ...
    private void initView() {
        View rootView = inflater.inflate(R.layout.window_with_hold, null);
