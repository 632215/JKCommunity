...
//        }
    ...
    public static void deleteAcache(Context context) {
        // TODO: 2018/6/12 需要不断添加
        SharedPreferencesUtils.clearRedCirclePerson(context);
        SharedPreferencesUtils.clearTempHouseBean(context);
        ACache aCache = ACache.get(context);
        CallCenterBean callCenterBean = null;
        HouseValueBean houseValueBean = null;
        LifeTopBannerBean lifeTopBannerBean = null;
        NoticeListBean noticeListBean =null;
        WeatherBean weatherBean = null;
        aCache.put("CallCenterBean", callCenterBean, ACache.TIME_DAY);
        aCache.put("HouseValueBean", houseValueBean, ACache.TIME_DAY);
        aCache.put("LifeTopBannerBean", lifeTopBannerBean, ACache.TIME_DAY);
        aCache.put("NoticeListBean", noticeListBean, ACache.TIME_DAY);
        aCache.put("WeatherBean", weatherBean, ACache.TIME_DAY);
    }
}
