...
public class BasePropertyDetailsBean {
    ...
    private PropertyBean.ListBean data;
    private int errcode;
    private String errmsg;
    private PageInfoBean pageInfo;

    public PropertyBean.ListBean getData() {
        return data;
    }

    public void setData(PropertyBean.ListBean data) {
        this.data = data;
    }
